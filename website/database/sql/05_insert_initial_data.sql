-- ============================================
-- Скрипт вставки начальных данных
-- Лабораторная работа 3
-- ============================================

-- Вставка данных только если таблицы пустые
-- Используется DO блок для проверки
...
BEGIN
    ...
    -- Создание категории (если нет категорий)
    ...
    -- Создание товаров (если нет товаров)
